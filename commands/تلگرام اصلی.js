...
User.setProperty("Proxy_Platform", "تلگرام اصلی");
...
Bot.sendInlineKeyboard(Buttons, "<Sex> [<FullName>](tg://user?id=" + UserID + ") بنا به درخواست شما پلتغرم پروکسی تلگرام اصلی با موفقیت فعال گردید.\n\n⚠️نکته:از فعالسازی مجدد این پلتفرم پروکسی خود داری کنید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
