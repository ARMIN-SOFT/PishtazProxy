/*CMD
  command: غیر فعالسازی سامانه پیامکی
  help: 
  need_reply: 
  auto_retry_time: 
  folder: 
...
User.setProperty("SMSs", "❌غیر فعال");
...
Bot.sendInlineKeyboard(Buttons, "<Sex> [<FullName>](tg://user?id=" + UserID + ") بنا به درخواست شما سامانه پیامکی با موفقیت غیر فعال گردید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
