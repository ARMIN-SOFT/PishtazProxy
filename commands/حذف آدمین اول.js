...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄بخش حذف آدمین در حال بار گذاری می باشد...",
show_alert: false
})
...
let Buttons1 = [
{title: "🔙بازگشت به منوی قبل", command: "بخش آدمین" },
{title: "🏠بازگشت به منوی مدیریت", command: "مدیریت دوم" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons1, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش حذف آدمین خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🔰آدمین قابل حذف بدین شرح است:\n\n⚠️آدمینی برای حذف وجود ندارد.\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
}

else {
let Buttons2 = [
{title: "❌حذف آدمین " + Add_Admin_UserID + " - " + Add_Admin_FullName + "", command: "حذف آدمین دوم" },
{title: "🔙بازگشت به منوی قبل", command: "بخش آدمین" },
{title: "🏠بازگشت به منوی مدیریت", command: "مدیریت دوم" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons2, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش حذف آدمین خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🔰آدمین قابل حذف بدین شرح است:\n\n👤آدمین:`<Add_Admin_FullName>` - `<Add_Admin_UserID>`\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
}
