...
text: "🔄بخش ادمین در حال بار گذاری می باشد...",
show_alert: false
})

if (Add_Admin_UserID == undefined){
let Buttons1 = [
[{title: "➕افزودن ادمین" , command: "افزودن ادمین اول"},{title: "➖حذف ادمین" , command: "حذف ادمین اول"}],
[{title: "🔙بازگشت به منوی قبل", command: "تنظیمات ربات" }],
[{title: "🏠بازگشت به منوی مدیریت", command: "مدیریت" }],
];

Bot.runCommand("پیکربندی");
Bot.sendInlineKeyboard(Buttons1, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش ادمین خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🔰ادمین ربات بدین شرح است:\n\n⚠️ادمینی برای نمایش وجود ندارد.\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
}
...
Bot.runCommand("پیکربندی");
Bot.sendInlineKeyboard(Buttons2, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش ادمین خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🔰ادمین ربات بدین شرح است:\n\n👤ادمین:`<Add_Admin_FullName>` - `<Add_Admin_UserID>`\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
}
}
