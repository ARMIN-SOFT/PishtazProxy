...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄افزودن پلاس مسنجر در حال بار گذاری می باشد...",
show_alert: false
})
...
Bot.sendInlineKeyboard(Buttons, "<Sex> [<FullName>](tg://user?id=" + UserID + ") به بخش افزودن پلاس مسنجر خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی زیر کلیک کنید.");

Bot.runCommand("افزودن پلاس مسنجر دوم");
