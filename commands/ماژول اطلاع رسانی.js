...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄ماژول اطلاع رسانی در حال بارگذاری می باشد...",
show_alert: false
})
...
let Buttons = [
[{title: "✉️سامانه پیامکی", command: "سامانه پیامکی" },{title: "📧سامانه ایمیلی", command: "سامانه ایمیلی" }],
[{title: "🔙بازگشت به منوی قبل", command: "پروکسی تلگرام" }],
[{title: "🏠بازگشت به منوی اصلی", command: "داشبورد حساب کاربری" }],
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons,"<Sex> [<FullName>](tg://user?id=" + UserID + ") به بخش ماژول اطلاع رسانی خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
