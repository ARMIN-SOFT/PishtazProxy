...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄بازیابی حساب در حال بار گذاری می باشد...",
show_alert: false
})

Bot.sendMessage("🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش بازیابی حساب خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🙇‍♂لطفا به پرسش هایی که از شما پرسیده می شود به درستی پاسخ دهید.");

Bot.runCommand('بازیابی حساب اول بررسی اول');
