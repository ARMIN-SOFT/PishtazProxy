...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄طراحی ربات در حال بار گذاری می باشد...",
show_alert: false
})
...
Bot.sendInlineKeyboard(Buttons, "🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش طراحی ربات خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🙇‍♂لطفا به پرسش هایی که از شما پرسیده می شود به درستی پاسخ دهید.");

Bot.runCommand("طراحی ربات دوم");
