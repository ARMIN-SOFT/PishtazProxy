...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄بخش ارسال پیامک تکی در حال بار گذاری می باشد...",
show_alert: false
})
...
Bot.sendInlineKeyboard(Buttons, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش ارسال پیامک تکی خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");

Bot.runCommand("ارسال پیامک تکی دوم");
