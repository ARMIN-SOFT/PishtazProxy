...
User.setProperty("Connect_Platform", "🔌ساده و پیشرفته");
...
let Buttons = [
{title: "🔙بازگشت به منوی قبل", command: "پلتفرم اتصال" },
{title: "🏠بازگشت به منوی اصلی", command: "داشبورد حساب کاربری" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "<Sex> [<FullName>](tg://user?id=" + UserID + ") بنا به درخواست شما پلتفرم پروکسی ساده و پیشرفته با موفقیت فعال گردید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
