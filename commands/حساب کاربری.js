...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄حساب کاربری در حال بار گذاری می باشد...",
show_alert: false
})

let Buttons = [
[{title: "📝ایجاد حساب", command: "ایجاد حساب" },{title: "🚪ورود حساب", command: "ورود حساب" },{title: "🔖بازیابی حساب", command: "بازیابی حساب" }],
[{title: "🏠بازگشت به منوی اصلی", command: "منوی خدمات ربات" }],
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش حساب کاربری خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
