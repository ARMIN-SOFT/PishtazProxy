...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄عدم تایید اطلاعات در حال بار گذاری می باشد...",
show_alert: false
})
...
Bot.sendInlineKeyboard(Buttons, "❌کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") عدم تایید اطلاعات شما با موفقیت در سیستم انجام شد.\n\n<DateTime> \n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
