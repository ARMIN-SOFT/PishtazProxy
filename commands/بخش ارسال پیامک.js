...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄بخش ارسال پیامک در حال بار گذاری می باشد...",
show_alert: false
})
...
let Buttons = [
[{title: "📨ارسال پیامک تکی" , command: "ارسال پیامک تکی اول"},{title: "📨ارسال پیامک همگانی" , command: "ارسال پیامک همگانی اول"}],
[{title: "🔙بازگشت به منوی قبل", command: "تنظیمات ربات" }],
[{title: "🏠بازگشت به منوی مدیریت", command: "مدیریت دوم" }],
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش ارسال پیامک خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
