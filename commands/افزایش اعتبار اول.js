...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄بخش افزایش اعتبار در حال بار گذاری می باشد...",
show_alert: false
})
...
{title: "🏠بازگشت به منوی اصلی", command: "مدیریت دوم" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش افزایش اعتبار خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
