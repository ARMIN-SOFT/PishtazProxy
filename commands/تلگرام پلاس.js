...
User.setProperty("Proxy_Platform", "تلگرام پلاس");
...
let Buttons = [
{title: "🔙بازگشت به منوی قبل", command: "پلتفرم اتصال پروکسی" },
{title: "🏠بازگشت به منوی اصلی", command: "داشبورد حساب کاربری" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "<Sex> [<FullName>](tg://user?id=" + UserID + ") بنا به درخواست شما پلتغرم پروکسی تلگرام پلاس با موفقیت فعال گردید.\n\n⚠️نکته:از فعالسازی مجدد این پلتفرم پروکسی خود داری کنید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
