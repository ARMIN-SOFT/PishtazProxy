...
Bot.sendMessage("📮کد تایید اعتبار سنجی از طریق پیامک به شماره موبایل " + Result + " ارسال گردید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n⚠️نکته:بدلیل ارتقاء سطح امنیتی حساب کاربری نیاز به کد تایید اعتبار سنجی می باشد.")
...
Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboardToChatWithId(Admin, Buttons, "✔️مدیریت گرامی [آرمین اسکندری](tg://user?id=592526230) لحظاتی پیش کد تایید اعتبار سنجی کاربر [<FullName>](tg://user?id=" + UserID + ") از طریق سامانه پیامکی دریافت گردید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🔒کد تایید اعتبار سنجی:`" + Validation + "`\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");
