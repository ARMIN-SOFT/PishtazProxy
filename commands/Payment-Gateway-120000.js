...
Bot.runCommand("پیکربندی");
Bot.sendInlineKeyboardToChatWithId(Admin, Buttons2, "✔️مدیریت گرامی [آرمین اسکندری](tg://user?id=592526230) لحظاتی پیش کاربر [<FullName>](tg://user?id=" + UserID + ") جهت شارژ اعتبار به مبلغ ۱۲۰،۰۰۰ تومان وارد درگاه پرداخت سپال گردید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n🔮شناسه پرداخت:`" + Payment_Code + "`\n`" + FullName + "` *-* `" + UserID + "`\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
