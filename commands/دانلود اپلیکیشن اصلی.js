...
let Buttons = [
[{title: "🟢رسمی", command: "رسمی اصلی" },{title: "🔴غیر رسمی", command: "غیر رسمی اصلی" }],
[{title: "🏠بازگشت به منوی اصلی", command: "منوی خدمات ربات" }],
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons,"🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش دانلود اپلیکیشن خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
