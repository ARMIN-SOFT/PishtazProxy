...
text: "🔄بخش افزودن ادمین در حال بار گذاری می باشد...",
show_alert: false
})
...
Bot.sendInlineKeyboard(Buttons, "🌹مدیریت گرامی [<FullName>](tg://user?id=" + UserID + ") به بخش افزودن ادمین خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.");

Bot.runCommand("افزودن ادمین دوم");
}
