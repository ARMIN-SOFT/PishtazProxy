...
Api.answerCallbackQuery({
callback_query_id: request.id,
text: "🔄پلتفرم اتصال پروکسی در حال بارگذاری می باشد...",
show_alert: false
})
...
let Buttons = [
[{title: "🔌تلگرام اصلی", command: "تلگرام اصلی" },{title: "🔌تلگرام پلاس", command: "تلگرام پلاس" }],
[{title: "🔙بازگشت به منوی قبل", command: "پروکسی تلگرام" }],
[{title: "🏠بازگشت به منوی اصلی", command: "داشبورد حساب کاربری" }],
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons,"<Sex> [<FullName>](tg://user?id=" + UserID + ") به بخش پلتفرم اتصال پروکسی خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
