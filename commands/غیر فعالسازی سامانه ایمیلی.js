/*CMD
  command: غیر فعالسازی سامانه ایمیلی
  help: 
  need_reply: 
  auto_retry_time: 
  folder: 
...
User.setProperty("Email", "❌غیر فعال");
...
Bot.sendInlineKeyboard(Buttons, "<Sex> [<FullName>](tg://user?id=" + UserID + ") بنا به درخواست شما سامانه ایمیلی با موفقیت غیر فعال گردید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
